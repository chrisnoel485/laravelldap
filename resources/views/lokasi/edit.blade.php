                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form role="form" action="{{ route('lokasi.update', $lokasi->id) }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="deskripsi" id="deskripsi" cols="5" rows="5" class="form-control {{ $errors->has('deskripsi') ? 'is-invalid':'' }}">{{ $lokasi->deskripsi }}</textarea>
                                            </div>
